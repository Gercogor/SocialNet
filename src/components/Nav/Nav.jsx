    ...
    return (
        <nav className={styles.nav}>
            <ul className={styles.list}>
                ...
                <li className={styles.item}><NavLink to={'/music'} style={({isActive}) => isActive ? activeStyle : undefined}>Music</NavLink></li>
                <li className={styles.item}><NavLink to={'/photos'} style={({isActive}) => isActive ? activeStyle : undefined}>Photos</NavLink></li>
            </ul>
        </nav>
    )
};
